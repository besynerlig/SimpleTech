<?php require "../db.php";
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //grab info for username to check if user exists
    $userExist = $con->query("SELECT username FROM users WHERE username = '$username'")->fetch_object()->username;
